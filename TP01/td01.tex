...
\textbf{2 -}
\textit{Soit M la matrice d’incidence de G, c’est-à-dire une matrice de taille |V(G)| × |E(G)| telle que m\subscript{ue} = 1 si l’arrête e est incidente au sommet u et mue = 0 sinon. Ecrire la matrice d’incidence du graphe de l’exercice précédent.}
